      ...
      cases: [
        {
          ...
          expected: "fire",
          pass: true,
          observed: { grader: "selection", actual: "fire", rationale: "Calendar scheduling matches." },
          attempts: 1, passedAttempts: 1, passRate: 1,
        },
        {
          grader: "selection",
          caseId: "case-2",
          ...
          expected: "silent",
          pass: false,
          observed: { grader: "selection", actual: "fire", rationale: "The description mentions customer follow-up work." },
          attempts: 1, passedAttempts: 0, passRate: 0,
        },
      ],
    };
