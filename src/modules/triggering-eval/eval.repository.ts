...
import type { AnalysisReadFilter, ComparableEvalRun, EvalRun, EvalRunAnalysisRecord } from "./triggering-eval.types";
...
export interface EvalRunRepository {
  ...
  findComparableById(
    id: EvalRunId,
    userId: UserId,
  ): Promise<Result<ComparableEvalRun | null, DomainError>>;
