 ...
 * §9.3) — the bounded-by-construction shape of the skill-count cap. */
...
/** Skills held per account (ARCHITECTURE §8) — a structural bound on storage,
 * not spend: held skills cost no tokens, so the cap is wide enough for the
 * import wedge while keeping accounts bounded by construction. */
export const SKILL_COUNT_MAX = 5;
...
export const LIMIT_MESSAGES = {
  ...
  skillCount: "You're at your skill limit - delete a skill to make room.",
} as const;
