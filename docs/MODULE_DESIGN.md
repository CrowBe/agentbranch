...
| Agent-configuration import preview | analysis | `agent-configuration-import` | validated source snapshot + runtime adapter probes → redacted runtime-neutral snapshot, evidence, warnings, unsupported content, and collisions (pure) | `preview` | real |
